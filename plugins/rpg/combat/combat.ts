...
export default class Combat {
	...
	resp: string = '';
	readonly attacker: Char | Party;
	readonly defender: Char | Party;
	 ...
	 * @returns {Promise}
	 */
	async partyAttack(p: Party, targ: Char | Party) {
	...
	async tryHit(src: Char, dest: Char, srcParty?: Party) {
	...
	async doLoot(dest: Char | Party, loot) {
...
class AttackInfo {
	...
	readonly attacker: Char;
	readonly defender: Char;
	...
	constructor(attacker: Char, defender: Char, party: Party) {
